...
type
  TFormSharingContract = class(TForm)
    ...
    procedure ShareContractTransferImage(const Sender: TObject; const ARequest: IDataProviderRequest);
...
begin
  ...
  FShareWrapper.OnTransferImage := ShareContractTransferImage;
end;
...
procedure TFormSharingContract.ShareContractTransferImage(const Sender: TObject; const ARequest: IDataProviderRequest);
begin
