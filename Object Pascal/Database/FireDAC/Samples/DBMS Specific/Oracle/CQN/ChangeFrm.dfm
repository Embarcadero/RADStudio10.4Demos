object frmChange: TfrmChange
  Left = 0
  Top = 0
  Caption = 'Oracle 10.2 Continuous Query Notification'
  ClientHeight = 660
  ClientWidth = 672
  Color = clBtnFace
  ...
  object btnStartTX: TButton
    ...
    Caption = 'Start TX'
    TabOrder = 11
    OnClick = btnStartTXClick
  end
  object btnCommitTX: TButton
    Left = 153
    Top = 8
    Width = 67
    Height = 25
  ...
  object qChanges: TFDQuery
    ...
    SQL.Strings = (
      'select t.rowid, t.* from "FDQA_TransTable" t')
    Left = 120
    Top = 322
  end
