...
type
  TFShareComponent = class(TForm)
    ...
    procedure ShareContractComponentTransferImage(const Sender: TObject; const ARequest: IDataProviderRequest);
  private
...
procedure TFShareComponent.ShareContractComponentTransferImage(const Sender: TObject; const ARequest: IDataProviderRequest);
begin
